    ...
    <>
      ...
      <div className={styles.OtherPrjtMain}>
        {smallProjects.map((project, key) => {
          return (
            <>
              <div key={key} className={styles.OtherPrjtDiv}>
                <div>
      ...
      <div className={styles.morePrjectDiv}>
        <a target="_blank" rel="noreferrer" href="https://github.com/Humza-Aa">
          <div className={styles.moreProjBtn}>
